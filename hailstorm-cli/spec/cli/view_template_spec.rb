...
describe Hailstorm::Cli::ViewTemplate do
  ...
  context '#render_jmeter_plans' do
    it 'should not raise_error' do
      expect { @app.render_jmeter_plans([@test_plan], only_active: true) }.to_not raise_error
    end
  end
  ...
  context '#render_load_agents' do
    it 'should not raise_error' do
      ...
      expect { @app.render_load_agents([cluster], only_active: true) }.to_not raise_error
    end
  end
  ...
  context '#render_target_hosts' do
    it 'should not raise_error' do
      ...
      expect { @app.render_target_hosts([target_host], only_active: true) }.to_not raise_error
    end
  end
  ...
  context '#render_results_show' do
    before(:each) do
      ...
      stopped_at = Time.now
      stopped_state = Hailstorm::Model::ExecutionCycle::States::STOPPED
      execution_cycle = Hailstorm::Model::ExecutionCycle.create!(project: @project,
                                                                 status: stopped_state,
      ...
      Hailstorm::Model::ClientStat.create!(execution_cycle: execution_cycle, jmeter_plan: @test_plan,
                                           ...
                                           threads_count: 10_000, aggregate_ninety_percentile: 789.56,
