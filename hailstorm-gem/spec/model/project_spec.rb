  ...
  context '#results' do
    context 'import' do
      it 'should import with selected jmeter, cluster and execution cycle' do
        project = Hailstorm::Model::Project.where(project_code: 'product_spec_results_import_selected_options')
                                           .first_or_create!
        ...
        jmeter_plan = project.jmeter_plans.where(test_plan_name: 'bar', content_hash: '63e456')
        ...
        data_center = cluster.cluster_klass
                             .where(user_name: 'zed', ssh_identity: 'zed', machines: ['172.16.80.25'],
