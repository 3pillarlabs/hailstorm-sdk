  ...
  return (
    <div className="card">
      <header className="card-header">
        <p className="card-header-title">{cluster.title}</p>
      </header>
      <div className="card-content">
        <div className="content">
          <div className="field">
            <label className="label">Username</label>
            <div className="control">
              <input readOnly type="text" className="input static" value={cluster.userName} />
            </div>
          </div>
          <div className="field">
            <label className="label">Username</label>
          ...
          <div className="field">
            <label className="label">SSH Identity</label>
            <div className="control">
              <input readOnly type="text" className="input static" value={cluster.sshIdentity.name} />
            </div>
          </div>
          <div className="field">
            <label className="label">Machines</label>
            <div className="control">
              ...
              <div className="field" key={value}>
                <div className="control">
                  <input readOnly type="text" className="input static" {...{value}} />
                </div>
              </div>
              ))}
            </div>
          ...
          <div className="field">
            <label className="label">SSH Port</label>
            <div className="control">
              <input readOnly type="text" className="input static" value={cluster.sshPort} />
            </div>
          </div>
        </div>
      </div>
