...
export function AWSForm({ dispatch, activeProject }: {
  ...
  return (<div className="card">
    ...
    <Formik isInitialValid={false} initialValues={{
      ...
      {({ isSubmitting, isValid }) => (<Form data-testid="AWSForm">
        <div className="card-content">
          <div className="field">
            <label className="label">AWS Access Key *</label>
            <div className="control">
              <Field required name="accessKey" className="input" type="text" data-testid="AWS Access Key" />
            </div>
          ...
          <div className="field">
            ...
            <div className="control">
              <Field required name="secretKey" className="input" type="password" data-testid="AWS Secret Key" />
            </div>
          ...
          <div className="field">
            ...
            <div className="control">
              <Field name="vpcSubnetId" className="input" type="text" data-testid="VPC Subnet" />
            </div>
          </div>
          <div className="field">
            <label className="label">AWS Region *</label>
            <div className="control">
              <AWSRegionChoice onAWSRegionChange={setAwsRegion} {...{ fetchRegions }} />
            </div>
          </div>
          {awsRegion ? (<>
            <div className="field">
