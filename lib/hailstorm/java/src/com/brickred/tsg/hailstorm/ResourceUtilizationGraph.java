...
public class ResourceUtilizationGraph {
	...
	/**
	 * Lazily loads all data in a graph as there may be a lot of data
	 * for resource utilization. This is different from the standard
	 * in-memory approach for other graphs.
	 * 
	 * @return
	 * @throws IOException
	 */
	public void startBuilder() {
		...
		CombinedDomainXYPlot plot = new CombinedDomainXYPlot(
				new NumberAxis("Elapsed Time, seconds"));
	...
	private XYPlot createCpuPlot() {
		...
		XYPlot plot = new XYPlot(dataSet, null, 
				new NumberAxis(key), 
	...
	public String finish() throws IOException {
		...
		ChartUtilities.writeChartAsPNG(chartOutputStream, utilizationChart, 640, 600);
